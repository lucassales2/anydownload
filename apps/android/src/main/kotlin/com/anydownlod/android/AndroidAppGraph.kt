...
class AndroidAppGraph(
    ...
    override val engine: DownloadEngine = AndroidRoutingEngine(
        ...
        classify = { url -> AndroidRouteClassifier().route(url) },
        scope = scope,
    )
    ...
    override val toolProbe: ToolProbe = AndroidToolProbe(port)
...
private class AndroidToolProbe(private val port: ChaquopyPort) : ToolProbe {
