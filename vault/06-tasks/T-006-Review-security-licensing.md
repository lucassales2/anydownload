...
Store distribution was closed by the owner on 2026-09-21. The project license is MIT as of the same day. Upstream dependency licenses and Q-09 are still open. spotDL is MIT on its README, inspected 2026-09-23; that is not a completed license review. Existing security notes are a preliminary inventory, not a legal opinion. See [Client yt-dlp options](../05-research/Client-yt-dlp-options.md).
